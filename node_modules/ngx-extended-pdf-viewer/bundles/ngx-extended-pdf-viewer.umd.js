(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/forms'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-extended-pdf-viewer', ['exports', 'rxjs', '@angular/forms', '@angular/core', '@angular/common'], factory) :
    (factory((global['ngx-extended-pdf-viewer'] = {}),global.rxjs,global.ng.forms,global.ng.core,global.ng.common));
}(this, (function (exports,rxjs,forms,i0,common) { 'use strict';
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
        ...
        NgxExtendedPdfViewerComponent.propDecorators = {
            ...
            minifiedJSLibraries: [{ type: i0.Input }],
