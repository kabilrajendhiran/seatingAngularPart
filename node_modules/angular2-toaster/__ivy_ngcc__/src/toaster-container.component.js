...
function ToasterContainerComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("toast", toast_r1)("@toastState", ctx_r0.toasterconfig.animation)("iconClass", ctx_r0.toasterconfig.iconClasses[toast_r1.type])("titleClass", ctx_r0.toasterconfig.titleClass)("messageClass", ctx_r0.toasterconfig.messageClass)("ngClass", ctx_r0.toasterconfig.typeClasses[toast_r1.type]);
} }
...
var ToasterContainerComponent = /** @class */ (function () {
    ...
    ToasterContainerComponent = __decorate([ __metadata("design:paramtypes", [ToasterService, ChangeDetectorRef, NgZone])
